...
public class _16MyFirstElement {
    ...
    public static void main(String a[]){
        ...
        arrl.add("Third");
        arrl.add("Random");
        System.out.println("First Element: "+arrl.element());  //Deque
        System.out.println("First Element: "+arrl.getFirst()); //Deque
        System.out.println("First Element: "+arrl.peek());     //Deque
        System.out.println("First Element: "+arrl.peekFirst());//Deque
