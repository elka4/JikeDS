...
//  715. Range Module - Array, Segment Tree, Binary Search Tree
public class _352_Data_Stream_as_Disjoint_Intervals_H {
//-------------------------------------------------------------------------
class Interval{
    int start,end;
...
Binary Search Tree
Similar Questions
Summary Ranges Find Right Interval Range Module
Java
 */