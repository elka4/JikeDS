 ...
 */
public class _465_Kth_Smallest_Sum_In_Two_Sorted_Arrays_Hard {
    ...
    public class Solution2 {
        ...
        class Pair implements Comparable<_465_Kth_Smallest_Sum_In_Two_Sorted_Arrays_Hard.Pair> {
            int x;
            int y;
            int sum;
            ...
            @Override
            public int compareTo(_465_Kth_Smallest_Sum_In_Two_Sorted_Arrays_Hard.Pair another) {
            ...
            public boolean equals(Object obj) {
                if (obj == this) {
                    return true;
                } else if (!(obj instanceof _465_Kth_Smallest_Sum_In_Two_Sorted_Arrays_Hard.Pair)) {
                    return false;
                }
                _465_Kth_Smallest_Sum_In_Two_Sorted_Arrays_Hard.Pair another = (_465_Kth_Smallest_Sum_In_Two_Sorted_Arrays_Hard.Pair) obj;
