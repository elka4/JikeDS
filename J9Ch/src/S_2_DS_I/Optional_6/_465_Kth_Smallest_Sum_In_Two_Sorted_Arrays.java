...
public class _465_Kth_Smallest_Sum_In_Two_Sorted_Arrays {
    ...
    public class Solution2 {
        ...
        class Pair implements Comparable<_465_Kth_Smallest_Sum_In_Two_Sorted_Arrays.Pair> {
            int x;
            int y;
            int sum;
            ...
            @Override
            public int compareTo(_465_Kth_Smallest_Sum_In_Two_Sorted_Arrays.Pair another) {
            ...
            public boolean equals(Object obj) {
                if (obj == this) {
                    return true;
                } else if (!(obj instanceof _465_Kth_Smallest_Sum_In_Two_Sorted_Arrays.Pair)) {
                    return false;
                }
                _465_Kth_Smallest_Sum_In_Two_Sorted_Arrays.Pair another = (_465_Kth_Smallest_Sum_In_Two_Sorted_Arrays.Pair) obj;
