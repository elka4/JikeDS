...
public class _272_Closest_Binary_Search_Tree_Value_II_H {
//----------------------------------------------------------------------------
    /*
...
//-------------------------------------------------------------------------------
    ...
    which is sorted because of in-order*/

    public List<Integer> closestKValues7(TreeNode root, double target, int k) {
...
//-------------------------------------------------------------------------------
        ...
        private void getPredecessor8(Stack<TreeNode> st){
...
//---------------------------------/////////////////
    ...
    // travelsal when the rightmost is larger than the leftmost.
    public List<Integer> closestKValues9(TreeNode root, double target, int k) {
