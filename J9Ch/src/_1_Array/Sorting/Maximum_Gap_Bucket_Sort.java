...
The basic idea is to project each element of the array to an array of buckets.
Each bucket tracks the maximum and minimum elements. Finally, scanning the bucket list, we can get the maximum gap.
...
public class Maximum_Gap_Bucket_Sort {
    class Bucket{
        int low;
        int high;
        public Bucket(){
