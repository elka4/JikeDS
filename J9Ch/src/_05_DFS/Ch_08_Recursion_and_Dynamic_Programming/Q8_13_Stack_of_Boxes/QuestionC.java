package _05_DFS.Ch_08_Recursion_and_Dynamic_Programming.Q8_13_Stack_of_Boxes;
...
public class QuestionC {	
	...
	public static void main(String[] args) {
		Box[] boxList = { new Box(6, 4, 4), new Box(8, 6, 2),
                new Box(5, 3, 3), new Box(7, 8, 3), new Box(4, 2, 2),
                new Box(9, 7, 3)};
