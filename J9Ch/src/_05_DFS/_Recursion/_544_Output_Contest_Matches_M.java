...
public class _544_Output_Contest_Matches_M {
...
//-------------------------------------------------------------------------///
    ...
    class Solution2{
        ...
        public String helper(List<String> sample){
            if(sample.size()==1){
                return sample.get(0);
            }
            List<String> newsample = new ArrayList<>();

            for(int i=0;i<sample.size()/2;i++){
                String temp = "("+sample.get(i)+","+sample.get(sample.size()-1-i)+")";
                newsample.add(temp);
            }

            return helper(newsample);
        }
    }
