...
By passing comparator object to the TreeMap, 
you can sort the keys based on the logic provided inside the compare method.

- See more at: http://www.java2novice.com/java-collections-and-util/treemap/comparator-user-object/#sthash.ADsLo2tL.dpuf*/
public class _10MyTMCompUserDefine {
