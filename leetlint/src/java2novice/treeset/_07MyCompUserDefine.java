package java2novice.treeset;

import java.util.Comparator;
import java.util.TreeSet;
 
public class _07MyCompUserDefine {
...
/*Program: Create TreeSet with comparator by user define objects.
...
To implement your own sorting functionality with TreeSet on user defined objects,
 ...
 You have to override compare() method to provide the sorting logic on user defined objects. 
 Below example shows how to sort TreeSet using comparator with user defined objects.

- See more at: http://www.java2novice.com/java-collections-and-util/treeset/comparator-object/#sthash.zOLDDKSr.dpuf*/
