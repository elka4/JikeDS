...
public class Bitmap implements Serializable{
    ...
    public static void main(String [] args) throws IOException{
        Bitmap unbLogo=new Bitmap ("/Users/tianhuizhu/Downloads/uber/code/JikeDS/leetcode/src/Bit_Manipulation_26/Bitmap/noisy.pbm");
        ...
        System.out.println(unbLogo);
        System.out.println("\f");
        unbLogo=new Bitmap ("/Users/tianhuizhu/Downloads/uber/code/JikeDS/leetcode/src/Bit_Manipulation_26/Bitmap/noisy.pbm");
        unbLogo.filter(2);
        System.out.println(unbLogo);
        System.out.println("\f");
        unbLogo=new Bitmap ("/Users/tianhuizhu/Downloads/uber/code/JikeDS/leetcode/src/Bit_Manipulation_26/Bitmap/noisy.pbm");
