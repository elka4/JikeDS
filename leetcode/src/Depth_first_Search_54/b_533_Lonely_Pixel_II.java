...
import java.util.*;
public class b_533_Lonely_Pixel_II {
//1 Verbose Java O(m*n) Solution, HashMap
    ...
    @Test
    public void test01() {
        char[][] input = {{'W','B','W','B','B','W'}, {'W', 'B', 'W', 'B', 'B', 'W'},
                {'W','B','W','B','B','W'}, {'W','W','B','W','B','W'} };
        int inputInt = 3;
        System.out.println(findBlackPixel(input, inputInt));
    }
